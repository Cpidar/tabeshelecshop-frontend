...
const NcInputNumber: FC<NcInputNumberProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <button
          className="w-8 h-8 rounded-full flex items-center justify-center border border-border bg-background focus:outline-none hover:border-border disabled:opacity-50 disabled:cursor-default"
          type="button"
