    ...
    >
      <label htmlFor={"searchId"} className="flex flex-1 items-center py-0.5">
        <input
          ...
          onChange={onChange}
          onFocus={onFocus}
          className="text-heading outline-none w-full h-[52px] ltr:pl-5 rtl:pr-5 md:ltr:pl-6 md:rtl:pr-6 ltr:pr-14 rtl:pl-14 md:ltr:pr-16 md:rtl:pl-16 bg-secondary text-foreground placeholder:text-muted-foreground text-sm lg:text-15px rounded-md transition-all duration-200 focus:border-accent focus:ring-0 border-secondary/0 border border-border-base"
        />
      </label>
      ...
      {/* {value ? ( */}
        ...
        >
          <MagnifyingGlass className="w-[17px] h-[17px] text-foreground text-opacity-40" />
        </button>
      {/* ) : (
