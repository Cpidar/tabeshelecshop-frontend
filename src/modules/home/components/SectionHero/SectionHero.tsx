    ...
    >
      <div className="flex flex-col lg:flex-row space-y-14 lg:space-y-0 lg:space-x-10 lg:items-center relative">
        <div className="w-screen max-w-full xl:max-w-xl space-y-5 lg:space-y-7">
          <h2 className="text-3xl leading-tight! font-semibold text-foreground md:text-4xl xl:text-5xl">
            {heading}
          </h2>
          <span className="block text-base xl:text-lg text-muted-foreground max-w-lg">
            {subHeading}
          </span>
