    ...
    <div data-testid="overview-page-wrapper">
      <div className="hidden small:block">
        <div className="text-xl-semi flex justify-between items-center mb-4">
          <span data-testid="welcome-message" data-value={customer?.first_name}>سلام {customer?.first_name}</span>
          <span className="text-small-regular text-ui-fg-base">
            شماره همراه: {" "}
            <span className="font-semibold" data-testid="customer-email" data-value={customer?.phone}>{customer?.phone}</span>
          </span>
        </div>
            ...
            <div className="flex flex-col gap-y-4">
              ...
              <ul className="flex flex-col gap-y-4" data-testid="orders-wrapper">
                {orders && orders.length > 0 ? (
                  ...
                  <span data-testid="no-orders-message">سفارشی وجود ندارد</span>
                )}
              </ul>
            </div>
          </div>
