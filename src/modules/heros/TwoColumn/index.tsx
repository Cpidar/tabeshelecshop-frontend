...
const SectionHero: FC<Page["hero"]> = ({
  ...
  if (rightMedia && typeof rightMedia === "object") {
    const url = rightMedia.url
    const cacheTag = rightMedia.updatedAt
    rightMediaSrc = `${getClientSideURL()}${url}?${cacheTag}`
  }
          ...
          >
            {sliderMedia && typeof sliderMedia === "object" && (
              <div
                ...
                style={{ backgroundImage: `url(${sliderMediaSrc})` }}
              >
                ...
                {sliderHero && sliderHero.length > 1 && (
