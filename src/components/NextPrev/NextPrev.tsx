...
const NextPrev: FC<NextPrevProps> = ({
  ...
  return (
    <div
      className={`nc-NextPrev relative flex items-center text-muted-foreground ${className}`}
      data-nc-id="NextPrev"
    ...
    >
      ...
      {!onlyPrev && (
        <button
          className={`${btnClassName}  border-border rounded-full flex items-center justify-center ${
