...
const NavigationItem: FC<NavigationItemProps> = ({ menuItem }) => {
        ...
        <div className="invisible sub-menu absolute top-full inset-x-0 transform z-50">
          <div className="bg-background shadow-lg">
            <div className="container">
              <div className="flex text-sm border-t border-border py-14">
        ...
        {() => (
          <>
            ...
            >
              ...
              >
                <ul className="rounded-lg shadow-lg ring-1 ring-border text-sm relative bg-background py-4 grid space-y-1">
  ...
  const renderDropdownMenuNavlink = (item: NavItemType) => {
    return (
      <LocalizedClientLink
        className="font-normal text-muted-foreground py-2 px-4 rounded-md hover:text-foreground hover:bg-muted"
        href={item.href!}
      >
        {item.name}
        {item.type && (
  ...
  const renderMainItem = (item: NavItemType) => {
    return (
      <div className="h-20 shrink-0 flex items-center">
        <LocalizedClientLink
          className="inline-flex items-center text-sm lg:text-[15px] font-medium text-foreground py-2.5 px-4 xl:px-5 rounded-full hover:text-foreground hover:bg-muted"
          href={item.href!}
          prefetch
        >
          {item.name}
