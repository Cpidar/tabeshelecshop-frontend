...
const SectionPromo2: FC<PromoBlock> = ({
  ...
  return (
    <div className={`nc-SectionPromo2 ${className}`}>
      <div className="relative flex flex-col lg:flex-row lg:justify-end bg-yellow-50 dark:bg-muted rounded-2xl sm:rounded-[40px] p-4 pb-0 sm:p-5 sm:pb-0 lg:p-24">
        <div className="absolute inset-0">
          <Image
            fill
            className="absolute w-full h-full object-contain opacity-5"
        ...
        <div className="lg:w-[45%] max-w-lg relative">
          ...
          <span className="block mt-6 text-slate-500 dark:text-muted-foreground">
            {description && (
